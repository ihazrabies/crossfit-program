module Template_three

def Template_three.template_three()
  ...
  puts "-" * 10
  puts " "
  puts "Monday: #{lift_reps[0]} squats at #{lift_weight[0]} and #{focus_reps[0]} #{focus_1}"
  puts " "
  ...
  puts "-" * 10
  puts " "
  puts "Monday: #{lift_reps[0]} squats at #{lift_weight[1]} and #{focus_reps[0]} #{focus_3}"
  puts " "
  short_1 = short_wod.generate("short") 
  puts " "
  ...
  long_1 = long_wod.generate("long")
  puts " "
  puts "Friday: #{lift_reps[1]} squats at #{lift_weight[4]}, #{focus_reps[1]} #{focus_1}"
  puts " "
  puts "Week 3"
  puts "-" * 10
  puts " "
  puts "Monday: #{lift_reps[0]} squats at #{lift_weight[2]} and #{focus_reps[1]} #{focus_2}"
  puts " "
  short_1 = short_wod.generate("short") 
  puts " "
  ...
  long_1 = long_wod.generate("long")
  puts " "
  puts "Friday: #{lift_reps[2]} squats at #{lift_weight[5]}, #{focus_reps[1]} #{focus_3}"
  puts " "
  puts "Week 4"
  puts "-" * 10
  puts " "
